...
/**Esta clase, Peces es una subclase de Animales, por lo tanto hereda de ella, no uso esta clase por lo explicado
...
public class Peces extends Animales {
    private String especie, habitat, medida, peso, profundidad, tiemponavegacion, numeroembarcaciones, hora,
            sexo, parasitos, anzuelos;//Estos son los atributos de la clase Peces.

    public Peces(String especie, String habitat, String medida, String peso, String profundidad,
