...
/**Esta clase, TiburonesMantas es una subclase de Animales, por lo tanto hereda de ella, no uso esta clase por lo explicado
 * anteriormente en la clase Animales.
 */
public class TiburonesMantas extends Animales {
    private String especie, habitat, medida, peso, profundidad, tiemponavegacion, numeroembarcaciones, hora,
            sexo, parasitos, anzuelos;//Estos son los atributos de la clase TiburonesMantas.

    public TiburonesMantas(String especie, String habitat, String medida, String peso, String profundidad,
