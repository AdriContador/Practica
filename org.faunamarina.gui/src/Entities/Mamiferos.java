...
/**Esta clase, Mamiferos es una subclase de Animales, por lo tanto hereda de ella, no uso esta clase por lo explicado
...
public class Mamiferos extends Animales {
    private String especie, habitat, medida, peso, profundidad, tiemponavegacion, numeroembarcaciones, hora,
            sexo, parasitos, anzuelos;//Estos son los atributos de la clase Mamiferos.

    public Mamiferos(String especie, String habitat, String medida, String peso, String profundidad,
